...
final class RomanshLanguageTest extends LanguageTestCase
{
    static $class = RomanshLanguage::class;
    ...
    {
        // canonical ordinals missing at https://www.unicode.org/cldr/charts/34/supplemental/language_plural_rules.html#rm
    }
}
